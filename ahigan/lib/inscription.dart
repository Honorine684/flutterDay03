...
import 'package:ahigan/animatedbar.dart';
...
class SignupState extends State<Signup> {
  ...
  // Méthode pour s'inscrire et stocker les données dans Firebase
  void signup() async {
    if (formKey.currentState!.validate()) {
      // Créez une nouvelle référence à la collection des utilisateurs
      CollectionReference usersManager = FirebaseFirestore.instance.collection('usersManager');

      // Ajoutez un nouvel utilisateur avec les informations fournies
      await usersManager.add({
        'name': name.text,
      ...
      Navigator.push(
          context, MaterialPageRoute(builder: (context) => const AnimatedBar()));
    }
  }
